...
void msdc_set_smpl(struct msdc_host *host, u8 HS400, u8 mode, u8 type, u8 *edge)
{
	...
	case TYPE_READ_DATA_EDGE:
		...
		if (mode == MSDC_SMPL_RISING || mode == MSDC_SMPL_FALLING) {
			...
			/*begin-add-xin_liu-20160111-merge MTK patch P11-d1210321*/
			...
			/*end-add-xin_liu-20160111-merge MTK patch P11-d1210321*/
...
static void msdc_set_bad_card_and_remove(struct msdc_host *host)
{
	...
	if (host->mmc->card) {
		...
		/*-begin-20160202-modify-by-zhangyong-for-D1231037-merge-mtk-patch-*/
		...
		/*-end-20160202-modify-by-zhangyong-for-D1231037-merge-mtk-patch-*/
		else {
			/*-begin-20160202-modify-by-zhangyong-for-D1231037-merge-mtk-patch-*/
			/*
			...
			*/
			pr_err("%s: %d\n", __func__, __LINE__);
			schedule_delayed_work(&host->remove_bad_card_work, 0);
			/*-end-20160202-modify-by-zhangyong-for-D1231037-merge-mtk-patch-*/
		}
...
static u32 msdc_power_tuning(struct msdc_host *host)
{
	...
	if (mmc_card_sd(card) && (host->hw->host_function == MSDC_SD)) {
		...
		*/
			 ...
			 ERR_MSG("the %d time Power cycle ,host->power_cycle == MSDC_MAX_POWER_CYCLE",
					 host->power_cycle);
		/*-end-20160202-modify-by-zhangyong-for-D1231037-merge-mtk-patch-*/
...
/*-begin-20160202-add-by-xin.liu-for-merge-mtk-patch-*/
...
/*-end-20160202-add-by-xin.liu-for-merge-mtk-patch-*/
...
static void msdc_remove_bad_card(struct work_struct *work)
{
      struct msdc_host *host = container_of(work, struct msdc_host, remove_bad_card_work.work);
...
#endif
	/*-begin-20160202-add-by-zhangyong-for-D1231037-merge-mtk-patch-*/
	INIT_DELAYED_WORK(&host->remove_bad_card_work, msdc_remove_bad_card);
	/*-end-20160202-add-by-zhangyong-for-D1231037-merge-mtk-patch-*/
