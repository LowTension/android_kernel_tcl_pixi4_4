...
void long_press_reboot_function_setting(void)
{
	...
	//begin-20160121-yuduan.xie-modify-for-mini-disable reboot
       //#ifdef TARGET_BUILD_GCF
      #if defined(TARGET_BUILD_MMITEST) || defined(TARGET_BUILD_GCF)
	//end-20160121-yuduan.xie-modify-for-mini-disable reboot
