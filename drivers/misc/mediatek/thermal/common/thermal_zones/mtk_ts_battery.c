...
/* BUG(); */
		/* arch_reset(0,NULL); */
               //BEGIN: add by jiangjingjing for  block shutdown beause of over temperature in MINI sw for task-811778-begin
               #ifndef TARGET_BUILD_MMITEST
		*(unsigned int *)0x0 = 0xdead;	/* To trigger data abort to reset the system for thermal protection. */
               #endif
              //end: add by jiangjingjing for  block shutdown beause of over temperature in MINI sw for task-811778-end
	}
	return 0;
}
