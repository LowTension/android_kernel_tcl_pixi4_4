...
static struct LCM_setting_table lcm_txd_initialization_setting[] = {
	...
	{0xB3, 2, {0x00,0xBB}},//SET VCOM
	{0xB4, 2, {0x00,0xBF}},//SET VCOM_R
	...
	{0xC8, 38, {0x7F,0x70,0x6B,0x4D,0x3E,0x28,0x2A,0x15,0x30,0x32,0x36,0x5A,0x4F,0x61,0x5A,0x63,0x5E,0x57,0x4E,0x7F,0x70,0x6B,0x4D,0x3E,0x28,0x2A,0x15,0x30,0x32,0x36,0x5A,0x4F,0x61,0x5A,0x63,0x5E,0x57,0x4E}},
...
unsigned int id0 = 0;
	...
	if (id_type == 3 && id0 == LCM_ID_JD9161B0 && id1 == LCM_ID_JD9161B1)//jd9161b ID_tpye is 01bit. 
		return 1;
	else
		return 0;
} 
...
// ---------------------------------------------------------------------------
LCM_DRIVER jd9161b_wvga_dsi_vdo_Holitech_lcm_drv_pixi44 =
{
	.name			= "jd9161b_wvga_dsi_vdo_Holitech_pixi44",
