...
static struct LCM_setting_table lcm_holitech_initialization_setting[] = {
	...
	{0x51,	1,	{0x85}},	// VGMN
	{0x52,	1,	{0x00}},	// Flicker 
	{0x53,	1,	{0x75}},	// Flicker  83 adj by peter wang, 0x7c
        //{0x54,	1,	{0x00}},
        //{0x55,	1,	{0x83}},
        //{0x57,	1,	{0x50}},
	...
	{0xA2,	1,	{0x22}},	// Gamma 247   
	{0xA3,	1,	{0x15}},	// Gamma 239   
	{0xA4,	1,	{0x0E}},	// Gamma 231  
	{0xA5,	1,	{0x1D}},	// Gamma 203  
	{0xA6,	1,	{0x09}},	// Gamma 175  
	{0xA7,	1,	{0x05}},	// Gamma 147   
	{0xA8,	1,	{0x07}},	// Gamma 108  
	{0xA9,	1,	{0x0F}},	// Gamma 80  
	{0xAA,	1,	{0x04}},	// Gamma 52  
	{0xAB,	1,	{0x0B}},	// Gamma 24   
	{0xAC,	1,	{0x1B}},	// Gamma 16    
	{0xAD,	1,	{0x23}},	// Gamma 8  
	{0xAE,	1,	{0x25}},	// Gamma 4      
	{0xAF,	1,	{0x00}},	// Gamma 0   
	///==============Nagitive       
	...
	{0xC2,	1,	{0x17}},	// Gamma 247  
	{0xC3,	1,	{0x13}},	// Gamma 239  
	{0xC4,	1,	{0x0C}},	// Gamma 231 
	{0xC5,	1,	{0x1B}},	// Gamma 203  
	{0xC6,	1,	{0x09}},	// Gamma 175   
	{0xC7,	1,	{0x0A}},	// Gamma 147   
	{0xC8,	1,	{0x00}},	// Gamma 108   
	{0xC9,	1,	{0x02}},	// Gamma 80   
	{0xCA,	1,	{0x06}},	// Gamma 52   
	{0xCB,	1,	{0x00}},	// Gamma 24    
	{0xCC,	1,	{0x05}},	// Gamma 16    
	{0xCD,	1,	{0x25}},	// Gamma 8   
	{0xCE,	1,	{0x1B}},	// Gamma 4    
	{0xCF,	1,	{0x00}},	// Gamma 0    
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_backporch=90;   //50  60 
	params->dsi.horizontal_frontporch=90;  //50   200
...
static void lcm_init(void)
{
	...
	push_table(lcm_holitech_initialization_setting, sizeof(lcm_holitech_initialization_setting) / sizeof(struct LCM_setting_table), 1);
}
...
static unsigned int lcm_compare_id(void)
{
	...
	//begin for temp 
	if (id_type ==3  && id_high == 0x98 && id_midd == 0x06) //ili9806e_holitech as  first  source ,and ID_tpye is 11bit. 
	{
		#if defined(BUILD_LK)
                printf("\t\t It's 9806e [ id_type  %d ]\n" , id_type);
		#else
	        printk("\t\t 9806e [lcm_compare_id   id_type  %d ]\n" , id_type);
		#endif
		return 1 ;
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_wvga_dsi_vdo_Holitech_lcm_drv_pixi44 =
{
	.name			= "ili9806e_wvga_dsi_vdo_Holitech_pixi44",
