...
static struct LCM_setting_table lcm_txd_initialization_setting[] = {
	...
	{0x51,	1,	{0x85}},	// VGMN
	{0x52,	1,	{0x00}},	// Flicker 
	{0x53,	1,	{0x6A}},	// Flicker  83 adj by peter wang, 0x7c
        //{0x54,	1,	{0x00}},
        //{0x55,	1,	{0x83}},
        //{0x57,	1,	{0x50}},
...
static unsigned int lcm_compare_id()
{
	...
	//begin for temp 
	if (id_type ==3  ) //ili9806e_holitech as  first  source ,and ID_tpye is 11bit. 
	{
		#if defined(BUILD_LK)
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_wvga_dsi_vdo_TXD_lcm_drv_pixi44 =
{
	.name			= "ili9806e_wvga_dsi_vdo_TXD_pixi44",
