...
CONFIG_BUILD_ARM_APPENDED_DTB_IMAGE_NAMES="pixi4_4"
...
CONFIG_MTK_PLATFORM="mt6580"
CONFIG_ARCH_MTK_PROJECT="pixi4_4"
CONFIG_MTK_SHARED_SDCARD=y
CONFIG_MTK_GPT_SCHEME_SUPPORT=y
CONFIG_MTK_SENSOR_SUPPORT=y
CONFIG_CUSTOM_KERNEL_IMGSENSOR="ov5670_mipi_raw s5k5e8yx_mipi_raw ov2680_mipi_raw gc2355_mipi_raw_rear gc2355_mipi_raw_front sp2508_mipi_raw gc0310_mipi_yuv gc5005_mipi_raw"
CONFIG_MTK_IRQ=y
...
CONFIG_MTK_CLKMGR=y
CONFIG_MTK_CHIP=y
CONFIG_MTK_CCCI_EXT=y
CONFIG_MTK_CCCI_DRIVER=y
CONFIG_MTK_DEVAPC_DRIVER=y
CONFIG_MTK_GPU_SUPPORT=y
CONFIG_MTK_GPU_VERSION="mali utgard"
CONFIG_MTK_MMPROFILE_SUPPORT=y
CONFIG_MMPROFILE=y
CONFIG_MTK_LCM=y

#Begin ersen.shang modify lcm
CONFIG_CUSTOM_KERNEL_LCM="ili9806e_wvga_dsi_vdo_Holitech_pixi44 fl10802_wvga_dsi_vdo_TXD_pixi44 hx8379c_wvga_dsi_vdo_TDT_pixi44 jd9161b_wvga_dsi_vdo_TXD_pixi44 jd9161b_wvga_dsi_vdo_Holitech_pixi44"
#End   ersen.shang modify lcm

CONFIG_MTK_FB=y
CONFIG_MTK_VIDEOX=y
CONFIG_MTK_LCM_PHYSICAL_ROTATION="0"

#Begin ersen.shang modify to 800*480
CONFIG_LCM_HEIGHT="800"
CONFIG_LCM_WIDTH="480"
#End   ersen.shang modify to 800*480
CONFIG_MTK_SYNC=y
CONFIG_MTK_PWM=y
...
#Begin ersen.shang for add ALSPS and remove unused switch
CONFIG_CTP_ALSPS=y
...
#End   ersen.shang for add ALSPS and remove unused switch
CONFIG_MTK_HWMON=y
...
CONFIG_MTK_FM_CHIP="MT6580_FM"
CONFIG_MTK_IMGSENSOR=y
CONFIG_MTK_BTIF=y
CONFIG_MTK_COMBO=y
CONFIG_MTK_COMBO_CHIP_CONSYS_6580=y
CONFIG_MTK_COMBO_BT=y
CONFIG_MTK_COMBO_GPS=y
CONFIG_MTK_COMBO_WIFI=y
CONFIG_MTK_GPS_SUPPORT=y

#Begin ersen.shang 20151029 for remove some unused switch
#CONFIG_MTK_LENS is not set
...
#End   ersen.shang 20151029 for remove some unused switch
...
#ersen.shang remove gt1151
# CONFIG_TOUCHSCREEN_MTK_GT1151 is not set
# CONFIG_GT1151_FIRMWARE is not set
# CONFIG_GT1151_CONFIG is not set

CONFIG_TOUCHSCREEN_MTK_FT6436=y
CONFIG_TOUCHSCREEN_MTK_MSG2238=y
#CONFIG_TOUCHSCREEN_MTK_FT5X0X  is not set

#Begin ersen.shang 20151029 remove unused compile switch
#CONFIG_GTP_DRIVER_SEND_CFG is not set
#CONFIG_GTP_CUSTOM_CFG is not set
#CONFIG_GTP_HOTKNOT is not set
#CONFIG_GTP_AUTO_UPDATE is not set
#CONFIG_GTP_HEADER_FW_UPDATE is not set
#CONFIG_GTP_CREATE_WR_NODE is not set
#CONFIG_GTP_POWER_CTRL_SLEEP is not set
#End   ersen.shang 20151029 remove unused compile switch
...
CONFIG_BATT_ID_CHECK_SUPPORT=y
#jiangjingjing modify for charge-20151109-enddefect 811778
...
CONFIG_PSTORE_MEM_ADDR=0x83F10000
...
CONFIG_SGM3146=y
CONFIG_HW_INFO=y
#add by fangyan for OTP  task742725,742727
